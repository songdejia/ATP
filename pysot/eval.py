...
def main():
    tracker_dir ='../tracking_results/atompp' #os.path.join(args.tracker_path, args.dataset)
    trackers = glob(os.path.join('../tracking_results/atompp', args.tracker_prefix+'*'))
    print(os.path.join(args.tracker_path, args.dataset, args.tracker_prefix+'*'))
